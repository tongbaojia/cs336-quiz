...
registerEssay(12, {
  ...
  "blocks": [
    ...
    {
      "p": "Take perplexity, the textbook intrinsic metric: \\(\\exp\\) of the mean per-token negative log-likelihood. It feels objective; it isn't comparable. Perplexity is <em>per token</em>, and a token is not a fixed unit — a coarser tokenizer cuts the same text into fewer, higher-information pieces, so a bigger vocabulary flatters the number for free. Report <strong>bits-per-byte</strong>, or you're comparing apples to oranges."
    },
    {
